...
# Build Output Paths
export APK_OUTPUT_PATH="$OUTPUT_DIR/flutter-apk/app-release.apk"
export AAB_OUTPUT_PATH="$OUTPUT_DIR/bundle/release/app-release.aab"
...
export GRADLE_WRAPPER_URL="https://services.gradle.org/distributions/gradle-7.5-all.zip"
